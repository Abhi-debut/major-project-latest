                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
                        <ul className="navbar-nav gap-4">
                            ...
                            <li className="nav-item">
                                <NavLink className="nav-link text-light" to='/maps'>Maps</NavLink>
                            </li>
                            <li className="nav-item">
                                <NavLink className="nav-link text-light" to='/aboutcancer'>About Cancer</NavLink>
                            </li>
                            <li className="nav-item">
                                <NavLink className="nav-link text-light" to='/hospitals'>Hospitals</NavLink>
                            </li>
                            <li>
